...
DECIDE_MANUAL_CODE_PROMPT = WORLD_CONTEXTUALIZATION_PROMPT + """
You are given the ability to check for the Codice Galattico and/or the Manuale di Cucina to obtain information useful to answer the user query.
...
Set the requires_manual and requires_code fields to True or False based on the information needed to answer the user query.
"""
